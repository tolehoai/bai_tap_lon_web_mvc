...
class Admin extends Controller{
    ...
    function TrangChu(){
        ...
        $this->view("pagemaster_admin", [
            "Page"=>"admin/trangquantri",
            "Mau"=>"red",
            "SoThich"=>["A", "B", "C"]
        ]);
    }
    function  SayHi(){
        $this->view("pagemaster_admin_login", [
            "Page"=>"admin/login",
    ...
    function AddDanhMuc(){
        ...
        if(isset($_POST["btnThemDanhMuc"]) && $_POST["txtTenDanhMuc"]!=""){
           ...
           echo '<script>window.location = "http://localhost:8080/web_mvc/Admin/AddDanhMuc" </script>'; 
       }
    ...
    function SuaDanhMuc($madanhmuc){
        ...
        $this->view("pagemaster_admin", [
            "Page"=>"admin/suadanhmuc",
            "danhmuc"=> $danhmuc->TimDanhMucTheoID($madanhmuc),
    ...
    function XuLySuaDanhMuc($id){
        ...
        if(isset($_POST["btnSuaDanhMuc"]) && $_POST["txtTenDanhMuc"]!=""){
           ...
           $url="http://localhost:8080/web_mvc/Admin/SuaDanhMuc/".$id;
            header("Location: $url");
    ...
    function SanPham($a){
        ...
        if($a=="TatCa"){
            ...
            $this->view("pagemaster_admin", [
                "Page"=>"admin/sanpham_trangchu",
                "danhmuc"=> $sanpham->DemSoLuongHangHoa(),
            ]);
        }
        else{
            $sanpham = $this->model("SanPhamModel");
            $this->view("pagemaster_admin", [
                ...
                "sanpham"=> $sanpham->GetSanPhamTheoLoai($a),
                "a"=>$a,
            ]);
        }
    }
    ...
    function XuLySuaSanPham($id){
       ...
       $url="http://localhost:8080/web_mvc/Admin/SanPham/TatCa";
            header("Location: $url");
    }
       ...
       function ThemThuongHieu(){
        ...
        if(isset($_POST["btnThemThuongHieu"]) && $_POST["txtTenThuongHieu"]!=""){
           ...
           echo '<script>window.location = "http://localhost:8080/web_mvc/Admin/ThemThuongHieu" </script>'; 
       }
    ...
    function SuaThuongHieu($mathuonghieu){
        ...
        $this->view("pagemaster_admin", [
            "Page"=>"admin/suathuonghieu",
            "thuonghieu"=> $thuonghieu->TimThuongHieuTheoID($mathuonghieu),
    ...
    function XuLySuaThuongHieu($id){
        ...
        if(isset($_POST["btnSuaThuongHieu"]) && $_POST["txtTenThuongHieu"]!=""){
           ...
           $url="http://localhost:8080/web_mvc/Admin/SuaThuongHieu/".$id;
            header("Location: $url");
