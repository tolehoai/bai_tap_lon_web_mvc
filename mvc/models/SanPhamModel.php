...
class SanPhamModel extends DB{
    ...
    public function TimSanPhamTheoID($str){
        $qr = "SELECT * from hang_hoa JOIN nhomhanghoa JOIN thuong_hieu
        WHERE hang_hoa.MANHOM = nhomhanghoa.MANHOM and hang_hoa.MSHS=$str and hang_hoa.MATHUONGHIEU=thuong_hieu.ma_thuong_hieu";
        return mysqli_query($this->con, $qr);
    }
